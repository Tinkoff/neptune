...
`ru.tinkoff.qa.neptune.core.api.steps.SequentialActionSupplier.DefinePerformOnParameterName` используются 
...
@SequentialActionSupplier.DefinePerformOnParameterName("Do:") // Дополнительный параметр, который как бы
