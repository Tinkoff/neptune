...
Данные свойства / переменные окружения могут быть настроены всегда, независимо от набора подключенных модулей Neptune.

Данные свойства / переменные окружения других модулей Neptune:
