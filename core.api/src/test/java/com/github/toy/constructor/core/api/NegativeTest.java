...
public class NegativeTest {
    ...
    public void testOfIllegalClass() {
        getProxied(Object.class, params());
        fail("The exception throwing was expected");
    }

    @Test(expectedExceptions = NoSuchMethodException.class)
    public void testOfCompletelyMismatchingParameters() {
        getProxied(GetStepStub.class, params()).get(toGet("Something", getStep -> new Object()));
        fail("The exception throwing was expected");
    }
    ...
    public void testOfPartiallyMismatchingParameters() {
        getProxied(GetStepStub.class, params("12345", 1, 1.5F, false))
    ...
    public void positiveTest() {
        assertThat(getProxied(GetStepStub.class, params("12345", 1, 1, false))
