...
public class PresenceTest {
    ...
    private static final Function<PresenceTestContext, Object> RETURNS_OBJECT = new StepFunction<>("Object",
            presenceTestContext -> new Object());

    private static final Function<PresenceTestContext, Object> RETURNS_NULL = new StepFunction<>("Null value",
            presenceTestContext -> null);

    private static final Function<PresenceTestContext, Object> RETURNS_OBJECT_ARRAY = new StepFunction<>("Object array",
            presenceTestContext -> new Object[]{1, "String"});

    private static final Function<PresenceTestContext, Object> RETURNS_EMPTY_ARRAY = new StepFunction<>("Empty array",
            presenceTestContext -> new String[]{});

    private static final Function<PresenceTestContext, Object> RETURNS_OBJECT_ITERABLE = new StepFunction<>("Object iterable",
            presenceTestContext -> of(1, "String"));

    private static final Function<PresenceTestContext, Object> RETURNS_EMPTY_ITERABLE = new StepFunction<>("Object iterable",
            presenceTestContext -> of());

    private static final Function<PresenceTestContext, Object> RETURNS_TRUE = new StepFunction<>("True value",
            presenceTestContext -> true);

    private static final Function<PresenceTestContext, Object> RETURNS_FALSE = new StepFunction<>("False value",
    ...
    private static final Function<PresenceTestContext, Object> PRODUCES_EXPECTED_EXCEPTIONS = new StepFunction<>("Expected exception",
            presenceTestContext -> {
