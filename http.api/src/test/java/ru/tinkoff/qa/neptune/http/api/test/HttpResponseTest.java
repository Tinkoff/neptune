...
public class HttpResponseTest extends BaseHttpTest {
    ...
    public void getResponseTest() {
        ...
        var response = http().get(responseOf(GET(URI), ofString()));
    ...
    public void postResponseTest() {
        ...
        var response = http().get(responseOf(POST(URI, stringBody("Test body")), ofString()));
    ...
    public void putResponseTest() {
        ...
        var response = http().get(responseOf(PUT(URI, stringBody("Test body")), ofString()));
    ...
    public void deleteResponseTest() {
        ...
        var response = http().get(responseOf(DELETE(URI), ofString()));
    ...
    public void methodResponseTest() {
        ...
        var response = http().get(responseOf(methodRequest(URI, "CUSTOM_METHOD"), ofString()));
