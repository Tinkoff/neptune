    ...
    private static Object[][] prepareDataForPathMapping(PathMapping someMappedAPI) {
        return new Object[][]{
                ...
                {someMappedAPI.getSomethingWithVariablePathArrayS("Start path",
                        ...
                        "/Start+path/Next+value/and/then/1,2,%D0%9A%D0%B8%D1%80%D0%B8%D0%BB%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9+%D1%82%D0%B5%D0%BA%D1%81%D1%82,true/end/point"},
                ...
                {someMappedAPI.getSomethingWithVariablePathArrayM("Start path",
                        ...
                        "/Start+path/Next+value/and/then/;array=1,2,%D0%9A%D0%B8%D1%80%D0%B8%D0%BB%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9+%D1%82%D0%B5%D0%BA%D1%81%D1%82,true/end/point"},
                ...
                {someMappedAPI.getSomethingWithVariablePathArrayME("Start path",
                        ...
                        "/Start+path/Next+value/and/then/;array=1;array=2;array=%D0%9A%D0%B8%D1%80%D0%B8%D0%BB%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9+%D1%82%D0%B5%D0%BA%D1%81%D1%82;array=true/end/point"},
                ...
                {someMappedAPI.getSomethingWithVariablePathObjectL("Start path",
                        ...
                        "/Start+path/Next+value/and/then/.Some+String/end/point"},
                ...
                {someMappedAPI.getSomethingWithVariablePathObjectM("Start path",
                        ...
                        "/Start+path/Next+value/and/then/;object=Some+String/end/point"},
                ...
                {someMappedAPI.getSomethingWithVariablePathObjectS("Start path",
                        ...
                        "/Start+path/Next+value/and/then/someString,String+value,someNum,10.1111,someBool,true,someList,1,ABC,%D0%90%D0%91%D0%92,true/end/point"},
                ...
                {someMappedAPI.getSomethingWithVariablePathObjectM("Start path",
                        ...
                        "/Start+path/Next+value/and/then/;object=someString,String+value,someNum,10.1111,someBool,true,someList,1,ABC,%D0%90%D0%91%D0%92,true/end/point"},
