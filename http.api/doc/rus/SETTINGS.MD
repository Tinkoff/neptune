...
Настройка указывает URL сервисов по умолчанию. Это корневой адрес приложения/приложений, обычно в формате `схема\протокол`://`хост`:`порт если есть/фрагмент/пути/если/надо`.
