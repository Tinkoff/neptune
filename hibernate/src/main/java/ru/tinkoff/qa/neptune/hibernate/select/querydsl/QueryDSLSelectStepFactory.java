...
public final class QueryDSLSelectStepFactory {
    ...
    public static <R> SelectOneStepSupplier<R> byPredicate(Class<?> entity, Predicate predicate) {
        return new QueryDSLSelectOneStepSupplierImpl<>(entity,
                new SelectByPredicateFunction.SelectOneByPredicate<>(predicate));
    }

    public static <R> SelectManyStepSupplier<R> allByPredicate(Class<?> entity, Predicate predicate) {
    ...
    allOrdered(Class<?> entity, OrderSpecifier<?> orderSpecifier) {
    ...
    allOrdered(Class<?> entity, Order order, Expression<C> target, OrderSpecifier.NullHandling handling) {
        return allOrdered(entity, new OrderSpecifier<>(order, target, handling));
    }

    public static <C extends Comparable<?>, R>
    SelectManyByOrderSpecifiersSupplier.SelectManyByPredicateAndOrderSpecifiersSupplier<R>
    allOrdered(Class<?> entity, Order order, Expression<C> target) {
    ...
    asAPageByPredicate(Class<?> entity, Predicate predicate) {
    ...
    private static final class QueryDSLSelectOneStepSupplierImpl<R> extends
        ...
        private QueryDSLSelectOneStepSupplierImpl(Class<?> entity, SelectByPredicateFunction<R> f) {
            super(entity, f);
    ...
    private static final class QueryDSLSelectManyStepSupplierImpl<R>
        ...
        private QueryDSLSelectManyStepSupplierImpl(Class<?> entity, SelectByPredicateFunction<Iterable<R>> select) {
            super(entity, select);
    ...
    private static class SelectManyByPredicateAndOrderSpecifiersSupplierImpl<R>
        ...
        protected SelectManyByPredicateAndOrderSpecifiersSupplierImpl(Class<?> entity) {
    ...
    private static class SelectManyByPredicateAndPageableSupplierImpl<R>
        ...
        protected SelectManyByPredicateAndPageableSupplierImpl(Class<?> entity,
