...
@PropertyDescription(description = "Defines when (which methods) it is necessary to refresh contexts/resources, e.g. back to the base browser page, renew db/http connections etc. " +
