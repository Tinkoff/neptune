...
It is under the ALPHA testing by [Tinkoff.ru](https://www.tinkoff.ru/software/) for a while. Built jar are not public
yet. Source code and documentation are available for overview.
