    ...
    public static Object[][] data6() {
        return new Object[][]{
                ...
                {RUSSIAN, LocalizationByResourceBundle.class, iterableInOrder("Статус ответа. is 200",
                        ...
                        "Заголовок(ки) ответа. 'Some header'. Значение соответствует 'равно 'Some value''",
                        "Заголовок(ки) ответа. 'Some header'. Значения соответствуют 'в следующем порядке: равно 'Some value', равно 'Some value2''",
                        ...
                        "Куки ответа.. 'someCookie'. Значение соответствует 'someValue'",
                        "Куки ответа.. 'someCookie'. Срок 'PT0.1S'",
                        "Куки ответа.. 'someCookie'. Срок соответствует '100'",
                        "Куки ответа.. 'someCookie'. Path=='somePath'",
                        "Куки ответа.. 'someCookie'. Path соответствует 'somePath'",
                        "Куки ответа.. 'someCookie'. Домен 'someDomain'",
                        "Куки ответа.. 'someCookie'. Домен соответствует 'someDomain'",
                        ...
                        "Тело ответа. Json path 'some.path'. Аргументы '{1,2,3,4}'. Значение соответствует 'больше чем 1'",
                        "Тело ответа. Json path 'some.path'. Аргументы '{1,2,3,4}'. Значение соответствует 'больше чем 1'. Значение как объект 'class java.lang.Integer'",
                        ...
                        "Тело ответа. Xpath './/*'. Неймспейсы '{}'. Аргументы '{1,2,true}'. Строка, соответствующая 'содержит строку 'ABCD''",
                        "Тело ответа. Xpath './/*'. Неймспейсы '{a=b, c=d}'. Аргументы '{1,2,true}'. Строка, соответствующая 'содержит строку 'ABCD''",
                        ...
                        "Тело ответа. Xpath './/*'. Неймспейсы '{}'. Аргументы '{1,2,true}'. Число нод соответствует 'больше чем 1'",
                        "Тело ответа. Xpath './/*'. Неймспейсы '{a=b, c=d}'. Аргументы '{1,2,true}'. Число нод соответствует 'больше чем 1'")},
        };
    }
