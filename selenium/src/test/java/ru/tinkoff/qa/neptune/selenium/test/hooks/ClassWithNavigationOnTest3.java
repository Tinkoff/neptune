...
@DefaultBrowserPage(rootUrlAt = "https://www.{host1}",
        pathAt = "/{parameter1}" +
                "/{parameter2}" +
                "/{parameter3}",
        queryAt = "?&p4={parameter4}" +
                "&p5={parameter5}" +
                "&p6={parameter6}" +
                "&p7={parameter7}")
public class ClassWithNavigationOnTest3 {
    ...
    @BrowserUrlVariable(toEncode = true)
    ...
    @BrowserUrlVariable(name = "parameter3", toEncode = true)
    ...
    @BrowserUrlVariable(name = "parameter6", field = "p6", toEncode = true)
    @BrowserUrlVariable(toEncode = true, field = "p7")
    ...
    @ForceNavigation(rootUrlTo = "https://{host2}",
            pathTo = "{parameter1}" +
                    "/{parameter2}" +
                    "/{parameter3}",
            queryTo = "&p4={parameter4}" +
                    "&p5={parameter5}" +
                    "&p6={parameter6}" +
                    "&p7={parameter7}")
    @PreventNavigationToDefaultURL
