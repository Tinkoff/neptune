...
public class PresenceTest extends BaseWebDriverTest {
    ...
    private static final Function<SeleniumStepPerformer, Object> RETURNS_OBJECT = toGet("Object",
            seleniumSteps -> new Object());

    private static final Function<SeleniumStepPerformer, Object> RETURNS_NULL = toGet("Null value",
            seleniumSteps -> null);

    private static final Function<SeleniumStepPerformer, Object> RETURNS_OBJECT_ARRAY = toGet("Object array",
            seleniumSteps -> new Object[] {1, "String"});

    private static final Function<SeleniumStepPerformer, Object> RETURNS_EMPTY_ARRAY = toGet("Empty array",
            seleniumSteps -> new String[] {});

    private static final Function<SeleniumStepPerformer, Object> RETURNS_OBJECT_ITERABLE = toGet("Object iterable",
            seleniumSteps -> of(1, "String"));

    private static final Function<SeleniumStepPerformer, Object> RETURNS_EMPTY_ITERABLE = toGet("Object iterable",
            seleniumSteps -> of());

    private static final Function<SeleniumStepPerformer, Object> RETURNS_TRUE = toGet("True value",
            seleniumSteps -> true);

    private static final Function<SeleniumStepPerformer, Object> RETURNS_FALSE = toGet("False value",
            seleniumSteps -> false);

    private static final Function<SeleniumStepPerformer, Object> PRODUCES_IGNORED_EXCEPTIONS = toGet("Ignored exception",
            seleniumSteps -> {
    ...
    private static final Function<SeleniumStepPerformer, Object> PRODUCES_EXPECTED_EXCEPTIONS = toGet("Expected exception",
    ...
    private static class TestGetSupplier extends GetStepSupplier<SeleniumStepPerformer, Object, TestGetSupplier> {
        public TestGetSupplier set(Function<SeleniumStepPerformer, Object> function) {
