...
public class ClassWithNavigationOnTest6 {
    ...
    @BrowserUrlVariable(name = "parameter5", method = "getP5")
    @BrowserUrlVariable(name = "parameter6", method = "getP6", toEncodeForQueries = true)
    @BrowserUrlVariable(toEncodeForQueries = true, method = "getP7")
