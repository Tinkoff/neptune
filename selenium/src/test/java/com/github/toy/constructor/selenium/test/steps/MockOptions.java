...
public class MockOptions implements WebDriver.Options {
    ...
    public MockOptions(MockWebDriver driver) {
        this.driver = driver;
        window1 = new MockWindow(driver, SIZE1.getSize(), POSITION_1.getPosition());
        window2 = new MockWindow(driver, SIZE2.getSize(), POSITION_2.getPosition());
        window3 = new MockWindow(driver, SIZE3.getSize(), POSITION_3.getPosition());;
    }
