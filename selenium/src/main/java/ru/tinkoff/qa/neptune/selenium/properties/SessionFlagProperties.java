...
public enum SessionFlagProperties implements BooleanValuePropertySupplier {
    ...
    @PropertyDescription(description = "It means that it will try to clear WebDriver cookies after the test running has finished if " +
            " 'true'. This option has sense if KEEP_WEB_DRIVER_SESSION_OPENED has value 'true'",
            section = "Selenium. Session flags")
