...
равно 1 минуте. Если этого слишком много или мало, тогда это время можно изменить, поменяв [настройку времени на поиск фрейма 
и переключение в него](./SETTINGS.MD#Поиск-и-переключение-во-фрейм). И тогда
