...
public class Tezzt {
    ...
    public void test() {
        ...
        boolean isAlertPresent = inBrowser().presenceOf(window(), //Ожидание наличия окна/вкладки.
                "Окно не появилось"); //Текст ошибки, если окно не появилось
        // вернется true если окно есть, если нет - 
        // будет выброшено исключение с текстом 'Окно не появилось'
