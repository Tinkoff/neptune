...
Так же матчеры, которые предоставляет Neptune:

- [Общего назначения](./../../../core.api/doc/rus/HAMCREST.MD)
- [Для интеграции с Selenium WebDriver](./../../../selenium/doc/rus/HAMCREST.MD)
- [Для Http](./../../../http.api/doc/rus/HAMCREST.MD)
