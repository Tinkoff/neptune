...
@Deprecated
public class DataBaseStepContextDeprecated implements GetStepContext<DataBaseStepContextDeprecated>, ActionStepContext<DataBaseStepContextDeprecated>, Stoppable,
        ContextRefreshable {
    ...
    public DataBaseStepContextDeprecated(DBConnection defaultConnection) {
     ...
     */
    DataBaseStepContextDeprecated switchTo(DBConnection dbConnection) {
     ...
     */
    DataBaseStepContextDeprecated switchTo(Class<? extends DBConnectionSupplier> dbConnectionSupplierClass) {
