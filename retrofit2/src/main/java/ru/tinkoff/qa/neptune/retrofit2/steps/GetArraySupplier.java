...
public class GetArraySupplier<M, R> extends SequentialGetStepSupplier
    ...
    public GetArraySupplier<M, R> responseCriteriaOr(Criteria<Response>... criteria) {
        ((SendRequestAndGet<M, R[]>) getFrom()).criteria(resultResponseCriteria(OR(criteria)));
        return this;
    }

    public GetArraySupplier<M, R> responseCriteriaOnlyOne(Criteria<Response>... criteria) {
        ((SendRequestAndGet<M, R[]>) getFrom()).criteria(resultResponseCriteria(ONLY_ONE(criteria)));
        return this;
    }

    public GetArraySupplier<M, R> responseCriteriaNot(Criteria<Response>... criteria) {
