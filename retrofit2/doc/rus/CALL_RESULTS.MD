...
- [Получение результата вызова http-метода](#Получение-результата-вызова-http-метода)
  ...
  - [Получение данных тела ответа как List](#Получение-данных-тела-ответа-как-list)
    - [Получение данных тела ответа как List. Call](#Получение-данных-тела-ответа-как-list-Call)
    - [Получение данных тела ответа как List. Случай без использования Call](#Получение-данных-тела-ответа-как-list-Случай-без-использования-Call)
...
[Критерии для получения подходящего http ответа](https://tinkoff.github.io/neptune/retrofit2/ru/tinkoff/qa/neptune/retrofit2/criteria/ResponseCriteria.html)
...
#### Получение данных тела ответа как List. Call
...
#### Получение данных тела ответа как List. Случай без использования Call
