...
Дефолтный поддерживаемый механизм основан на
использовании [ResourceBundle](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/ResourceBundle.html)
.
...
Будут сформированы файлы вида ``neptune_Localization_<name_of_the_module>_de_DE.properties``. Их контент будет похож на
пример ниже:
...
Все что теперь нужно — это заменить английский текст в значении каждого из свойств на немецкий, кроме ⚠️ выражений
внутри `{}`, их нужно оставить как есть
...
Будут сформированы файлы вида ``neptune_Localization_<name_of_the_module>_CUSTOM_ru_RU.properties``. Их контент будет
похож на пример ниже:
...
Все что теперь нужно — это исправить текст в значении каждого из свойств, кроме ⚠️ выражений внутри `{}`, их нужно
оставить как есть.
