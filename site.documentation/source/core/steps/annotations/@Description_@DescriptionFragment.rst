...
.. code-block:: java
   :caption: пример для произвольного объекта. Данный механизм можно использовать, если требуется :doc:`интернационализация <./../../internationalization>` объектов класса, который находится на поддержке и не входит в описанные выше примеры
