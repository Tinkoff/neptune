...
public class MyTest {
    ...
    public void myTest1() {
        SomeData someDataItem = kafka().poll(consumedItem(
                ...
                //начнется чтение сообщений из топиков.
                //Если действие не указывать, будут прочитаны все сообщения из топиков.
                .pollWith("Название или описание действия", () -> {
                    //тут можно вызвать шаги из других контекстов 
