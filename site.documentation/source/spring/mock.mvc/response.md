...
[посмотреть в документации. Названия методов начинаются на _
expect_](https://tinkoff.github.io/neptune/spring.mock.mvc/ru/tinkoff/qa/neptune/spring/mock/mvc/GetMockMvcResponseResultSupplier.html)
.
