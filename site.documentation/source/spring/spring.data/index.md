...
Данный модуль объединяет возможности _Neptune_ и [Spring Data](https://spring.io/projects/spring-data). Является
расширением [абстракций для работы с базами данных](./../../data.base/database.abstractions.md).
