...
public class SaveTest extends BaseSpringDataTest {
    ...
    @Mock
    Flowable<TestEntity> mockFlowableLocal;
    @Mock
    Single<List<TestEntity>> mockSingleLocalListUpd;
    @Mock
    ...
    @Mock
    private Single<TestEntity> mockSingleLocal;
    @Mock
    private io.reactivex.rxjava3.core.Single<TestEntity> mockSingleLocal2;
    @Mock
    private Single<TestEntity> mockSingleLocalUpd;
    @Mock
    ...
    public void prepareClass() {
        ...
        when(mockMaybe.blockingGet()).thenReturn(original.get(0));
        ...
        when(mockSingle.blockingGet()).thenReturn(original);
        ...
        when(testRxJava2SortingRepository.save(TEST_ENTITIES.get(0))).thenReturn(mockSingleLocal);
        ...
        when(testRxJava2SortingRepository.saveAll(TEST_ENTITIES)).thenReturn(mockFlowable);
        ...
        when(testRxJava2SortingRepository.save(updatedEntity)).thenReturn(mockSingleLocalUpd);
        ...
        when(testRxJava2SortingRepository.saveAll(updatedEntities)).thenReturn(mockFlowableLocal);
        when(testRxJava3SortingRepository.saveAll(updatedEntities)).thenReturn(mockFlowableLocal2);

        when(mockSingleLocal.blockingGet()).thenReturn(TEST_ENTITIES.get(0));
        when(mockSingleLocal2.blockingGet()).thenReturn(TEST_ENTITIES.get(0));

        when(mockMonoLocal.block()).thenReturn(updatedEntity);
        when(mockSingleLocalUpd.blockingGet()).thenReturn(updatedEntity);
        ...
        when(mockFlowableLocal.toList()).thenReturn(mockSingleLocalListUpd);
        when(mockSingleLocalListUpd.blockingGet()).thenReturn(updatedEntities);
    ...
    @Test
    public void saveOne3() {
        var entity = springData().save("Test entity",
                testRxJava2SortingRepository,
                TEST_ENTITIES.get(0));

        assertThat(entity, Matchers.is(TEST_ENTITIES.get(0)));
        verify(testRxJava2SortingRepository, times(1)).save(TEST_ENTITIES.get(0));
        verify(mockSingleLocal, times(1)).blockingGet();
    }
    ...
    @Test
    public void saveVarArg3() {
        var entity = springData().save("Test entities",
                testRxJava2SortingRepository,
                TEST_ENTITIES.get(0), TEST_ENTITIES.get(1));

        assertThat(entity, Matchers.is(TEST_ENTITIES));
        verify(testRxJava2SortingRepository, times(1)).saveAll(TEST_ENTITIES);
        verify(mockFlowable, times(1)).toList();
        verify(mockSingle, times(1)).blockingGet();
    }
    ...
    public void updateOne3() {
        ...
        assertThat(entity, Matchers.is(updatedEntity));
        verify(testRxJava2SortingRepository, times(1)).save(updatedEntity);
        verify(mockSingleLocalUpd, times(1)).blockingGet();
    }
    ...
    public void updateIterable3() {
        ...
        assertThat(entities, Matchers.is(updatedEntities));
        verify(testRxJava2SortingRepository, times(1)).saveAll(updatedEntities);
        verify(mockFlowableLocal, times(1)).toList();
        verify(mockSingleLocalListUpd, times(1)).blockingGet();
    }
    ...
    @Test
    public void updateIterableByQuery3() {
        var entities = springData().save("Test entities",
