...
Данный модуль поддерживает работу с
...
- [Шаги](#Шаги)
  - [Find-операции](#Find-операции)
    ...
    - [Pageable](#pageable)
    - [Example](#example)
      - [Example. Выбор одной записи.](#Example-Выбор-одной-записи)
      - [Example. Выбор нескольких записей.](#Example-Выбор-нескольких-записей)
    - [Query DSL](#query-dsl)
      - [Query DSL. Выбор одной записи.](#Query-DSL-Выбор-одной-записи)
      - [Query DSL. Выбор нескольких записей.](#Query-DSL-Выбор-нескольких-записей)
    - [Произвольный вызов метода репозитория](#Произвольный-вызов-метода-репозитория)
      - [Произвольный вызов метода репозитория. Выбор одной записи.](#Произвольный-вызов-метода-репозитория-Выбор-одной-записи)
      - [Произвольный вызов метода репозитория. Выбор нескольких записей.](#Произвольный-вызов-метода-репозитория-Выбор-нескольких-записей)
    - [Наличие / отсутствие записей или их данных](#Наличие--отсутствие-записей-или-их-данных)
  - [Delete-операции](#delete-операции)
  - [Save-операции](#save-операции)
...
свойства `SPRING_DATA_SLEEPING_TIME_UNIT` следует указать значение, соответствующее одному из элементов
...
- О контекстах можно прочитать [здесь](./../../../core.api/doc/rus/STEPS.MD#Контекст).
  Объект [контекста для работы со Spring Data](https://tinkoff.github.io/neptune/spring.data/ru/tinkoff/qa/neptune/spring/data/SpringDataContext.html)
