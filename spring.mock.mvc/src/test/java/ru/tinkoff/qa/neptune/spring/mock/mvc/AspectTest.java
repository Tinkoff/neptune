        ...
        return new Object[][]{
                ...
                {RUSSIAN, LocalizationByResourceBundle.class,
                        iterableInOrder("URL. Форвард. 'http://someforward/url'",
                                ...
                                "Jsonpath '$.store.book[*].author'. Аргументы {1,2,3}. Значение соответствует 'ABC'",
                                "Jsonpath '$.store.book[*].author'. Аргументы {}. Значение соответствует 'ABC' как 'class java.lang.String'",
                                ...
                                "Xpath './/store/book/author'. Неймспейсы '{a=b, c=d}'. Аргументы {1,2,3}. Нода соответствует 'есть объект, найденный по xpath './/*''",
                                "Xpath './/store/book/author'. Неймспейсы '{}'. Аргументы {1,2,3}. Нода соответствует 'есть объект, найденный по xpath './/*''",
                                ...
                                "Статус. 200",
                                "Статус. Соответствует 'больше чем 100'",
                                ...
                                "Статус. Причина соответствует 'равно 'Some reason''",
                                "Запрос. Асинхронная обработка не стартовала",
                                "View. Имя 'someName'",
                                "View. Имя соответствует 'expectViewName'",
                                "Model. Атрибут 'attr'. Значение '123'",
                                "Model. Атрибут 'attr'. Значение соответствует 'больше чем 100'",
                                "Model. Атрибут(ы) {attr1,attr2,attr3} существует(ют)",
                                "Flash-атрибут(ы). 'attr'. Значение '123'",
                                "Flash-атрибут(ы). 'attr'. Значение соответствует 'больше чем 100'",
                                ...
                                "Обработчик (обработчики). Имя метода соответствует 'handle'",
                                ...
                                "Заголовок (заголовки). 'someHeader'. Значение соответствует 'someValue1'",
                                "Заголовок (заголовки). 'someHeader'. Значение {someValue1,someValue2}",
                                "Заголовок (заголовки). 'someHeader'. Значение соответствует 'содержит элементы: {someValue1,someValue2}'",
                                ...
                                "Куки. 'someCookieName'. Значение соответствует 'someValue'",
                                "Куки. 'someCookieName'. Срок '2'",
                                "Куки. 'someCookieName'. Срок соответствует 'больше чем 1'",
                                "Куки. 'someCookieName'. Path=='/some/path'",
                                "Куки. 'someCookieName'. Path соответствует '/some/path'",
                                "Куки. 'someCookieName'. Домен 'some.domain'",
                                "Куки. 'someCookieName'. Домен соответствует 'some.domain'",
                                "Куки. 'someCookieName'. Коммент 'some comment'",
                                "Куки. 'someCookieName'. Коммент соответствует 'some comment'",
                                "Куки. 'someCookieName'. Версия '2'",
                                "Куки. 'someCookieName'. Версия соответствует 'больше чем 1'",
                                ...
                                "Исключение соответствует 'объект класса 'class java.lang.RuntimeException', сообщение 'равно 'Some message'''",
                                "Исключение соответствует 'объект класса 'class java.lang.RuntimeException', сообщение 'содержит строку 'Some', содержит строку 'message'''")}
        };
    }
